	...
	<div class="row" <?php echo $access['add']; ?>>
		<div class="profile-user-info profile-user-info-striped ">
            <div class="profile-info-row">
                ...
                <input type="text" name="product_code" id="product_code" class="input-xlarge" autocomplete="off" required="required" />
                </div>
            </div><!-- End group -->
            <div class="profile-info-row">
                <div class="profile-info-name">
                ...
                <div class="profile-info-value">
                <input type="text" name="product_name[thai]" id="product_name[thai]" class="input-xlarge" autocomplete="off" required="required" />
                </div>
                <?php if( multi_lang() ) : ?>
                <div class="profile-info-name">
                ...
                <div class="profile-info-value">
                <input type="text" name="product_name[english]" id="product_name[english]" class="input-xlarge" autocomplete="off" required="required" />
                </div>
                <?php endif; ?>
            </div><!-- End group -->
            <div class="profile-info-row"><!-- group -->
              ...
              <div class="profile-info-row"><!-- group -->
                ...
                <div class="profile-info-value">
               		<label for="home">
                          <input type="checkbox" name="id_parent" value="1" id="home" class="ace">
