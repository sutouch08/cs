...
<div class="container">
    <div class="row">
        <div class="col-lg-12">
                ...
                <div class="col-lg-12">
                	<a href="#"><button class="btn btn-success btn-block"><i class="fa fa-shopping-cart fa-3x">&nbsp; SHOP</i></button></a>
                </div>
                ...
                <div class="col-lg-12">&nbsp;</div>
                <div class="col-lg-12">
                	<a href="<?php echo valid_menu(1,"admin/main"); ?>"><button class="btn btn-danger btn-block"><i class="fa fa-gears fa-3x">&nbsp; Administrator</i></button></a>
                </div>
